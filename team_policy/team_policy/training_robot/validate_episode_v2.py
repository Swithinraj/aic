"""
Validate HDF5 episode files for Schema v5 and v6.

Extends the original validate_episode.py with v6-specific checks:
    ...
    with hf:
        ...
        if schema < 5:
            _report(issues, "schema_version", _WARN,
                    f"found version {schema}, expected 5 or 6")
...
def main():
    parser = argparse.ArgumentParser(
        description="Validate HDF5 episode files (schema v5 and v6)"
    )
    parser.add_argument(
        "path", nargs="+",
